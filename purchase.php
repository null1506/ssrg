...
?>
	<table class="table">
		...
		<?php
            // Mở kết nối SQL Server một lần cho toàn bộ vòng lặp
			$conn = db_connect(); // Hàm db_connect() phải được viết sử dụng sqlsrv_connect()
			foreach($_SESSION['cart'] as $isbn => $qty){
				// Giả sử hàm getBookByIsbn() đã được chuyển sang dùng sqlsrv_query()
